...
export default function ContactForm() {
	...
	const handleSubmit = (e) => {
		e.preventDefault();
		emailjs.sendForm('service_bdffdem', 'template_9zl7qsw', form.current, 'user_KIP4sbmL9itetpkyz3R88')
			.then((result) => {
	...
	return (
		<>
			...
			<div className="min-h-full flex items-center justify-center py-20 px-4 sm:px-6 lg:px-8">
				...
				{submitted ?
					(<>
						<div className="py-24 text-3xl z-10 text-white">Thank you! We'll be in touch soon.</div>
					</>)
					:
					(<div className="max-w-md w-full space-y-8 z-10">
						...
						<form ref={form} className="mt-8 space-y-6" method="POST" onSubmit={handleSubmit}>
