  ...
  return (
    <>
      <div className="w-full h-screen grid grid-cols-1">
        <Image className="object-cover brightness-75 shadow-md object-center" src="https://res.cloudinary.com/wrp/image/upload/v1642146255/winnie/bmw/BMW340i_9_hh9jcw.jpg" width={1} height={1} layout='responsive' />
       <span className="drop-shadow-xl h-0 z-10 drop-shadow-2xl absolute w-full align-center text-white inset-y-72 text-7xl md:text-5xl sm:text-4xl text-center"><h2 className='font-sans text-shadow-lg'>Winnie Lok Photography</h2></span>
