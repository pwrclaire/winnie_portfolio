  ...
  return (
    <>
      <div className="w-full h-screen grid grid-cols-1">
       ...
       <span className="drop-shadow-xl h-0 z-10 drop-shadow-2xl absolute w-full align-center text-white inset-y-48 text-7xl md:text-5xl sm:text-4xl text-center"><h2 className='font-sans text-shadow-lg'>Winnie Lok Photography</h2></span>
