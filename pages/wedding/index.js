    ...
    <>
      ...
      <div className="grid grid-cols-2 md:grid-cols-1 gap-6 p-10 mt-16 top-28">
        <div className="relative h-[90vh] md:h-[40vh]">
          ...
          <div class="opacity-0 hover:opacity-100 bg-black bg-opacity-40 duration-300 absolute inset-0 z-10 flex justify-center items-center text-6xl text-white font-semibold">Wendy & Kevin</div>
            <Image
