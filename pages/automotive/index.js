...
export default function Cars() {
	return (
		<>
			<div className='grid grid-cols-2 w-full h-screen lg:grid-cols-1'>
				{/* bmw */}
				<a a href="/automotive/bmw">
					<div style={{ width: '100%', height: '100%', position: 'relative' }}>
					<p className='absolute z-10 w-full align-center text-white text-center text-7xl inset-y-1/3 pointer-events-none'>BMW</p>
				...
				<a a href="/automotive/jaguar">
					<div style={{ width: '100%', height: '100%', position: 'relative' }}>
					<p className='absolute align-center w-full text-center z-10 text-white text-7xl inset-y-1/3 pointer-events-none'>Jaguar</p>
