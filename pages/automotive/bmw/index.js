  ...
  return (
    <div>
      <Banner title='BMW 340i'/>
        ...
        <Image priority className="object-cover shadow-md" src="https://res.cloudinary.com/wrp/image/upload/v1642146256/winnie/bmw/BMW340i_2_dtds49.jpg" width={2} height={3} layout='responsive'/>
