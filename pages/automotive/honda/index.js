    ...
    <div>
      {Banner('Honda')}
        ...
        <div className='grid grid-row-2 gap-2'>
          <Image className="object-cover shadow-md" src="https://res.cloudinary.com/wrp/image/upload/v1642576911/winnie/civic/HC6_yoxgut.jpg" width={9} height={6} layout='responsive' />
          <Image className='object-cover' src="https://res.cloudinary.com/wrp/image/upload/v1642576911/winnie/civic/HC4_gg3cdt.jpg" width={9} height={6} layout='responsive' />
        </div>
