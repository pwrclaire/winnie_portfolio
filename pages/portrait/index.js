...
export default function People() {
	return (
		<div className='grid grid-cols-2 w-full h-screen md:grid-cols-1 md:h-screen'>
			{/* chris */}
			<div className='md:h-screen'>
				<a a href="/portrait/chris">
					<div style={{ width: '100%', height: '100%', position: 'relative' }}>
						<p className='absolute z-10 w-full md:w-full align-center text-white text-center text-5xl md:text-4xl inset-y-1/3 pointer-events-none'>Chris & Raph</p>
