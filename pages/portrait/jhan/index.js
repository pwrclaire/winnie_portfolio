  ...
  return (
    <div>
      ...
      <div className='col-span-2'>
        ...
        <Image className='object-cover' src="https://res.cloudinary.com/wrp/image/upload/v1642146256/winnie/kush_jhan/JHan_Khush6_ywxlhm.jpg" width={9} height={6} layout='responsive' />
        <div className='col-span-2'>
