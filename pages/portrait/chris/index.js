  ...
  return (
    <div>
      ...
      <div className="grid grid-cols-2 md:grid-cols-1 gap-2 md:flex md:flex-col">
        ...
        <Image priority className='object-cover shadow-md' src="https://res.cloudinary.com/wrp/image/upload/v1642146257/winnie/chris_raph/DSC_3392_gm7qxx.jpg" width={9} height={6} layout='responsive' />
        <Image priority className="object-cover shadow-md" src="https://res.cloudinary.com/wrp/image/upload/v1642146257/winnie/chris_raph/DSC_3471_bufscv.jpg" width={9} height={6} layout='responsive' />
        <div className='col-span-2'>
